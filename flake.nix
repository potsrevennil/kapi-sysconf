{
  ...
  inputs = {
    ...
    # NixOS+u-boot image for the odroid host from scratch. nixos-hardware
    # provides the rockchip platform module; u-boot, ATF, and rkbin come
    # from nixpkgs directly (mainline 26.05 has odroid-m2-rk3588s_defconfig).
